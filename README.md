...
Save and Save as - Upon attempting to save with no file, program crashes
...
## Future Change Ideas
- Add a window that pops up upon exiting the program if an image has been edited during that run, but hasn't been saved
- 