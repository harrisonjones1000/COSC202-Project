...
public class FilterActions {
    ...
    public FilterActions() {
        ...
        actions.add(new MedianFilterAction("Median Blur filter", null, "Apply a Median Blur filter", Integer.valueOf(KeyEvent.VK_D)));
    }
    ...
    public class GaussianBlurFilterAction extends ImageAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            SpinnerNumberModel radiusModel = new SpinnerNumberModel(1, 1, 10, 1);
            JSpinner radiusSpinner = new JSpinner(radiusModel);
            int option = JOptionPane.showOptionDialog(null, null, "Enter filter radius", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, null, null);
